...
require("tippy.js/dist/tippy.css"); // optional for styling
/* END */
...
function ValidateStartCommand() {
    ...
    document.getElementById("linux-docker-fields").className =
...
function onInputChange() {
    ...
    readWriteValue(GetElementValue("NumHeartBeatsForTerminateResponse"), "NumHeartBeatsForTerminateResponse", lmaConfig);
...
allInputElementsArray.forEach((inputElement) => {
...
allSelectElementsArray.forEach((selectElement) => {
